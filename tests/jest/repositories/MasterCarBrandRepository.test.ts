...
jest.mock("../../../src/domain/entities/MasterCarBrandEntity");

describe("MasterCarBrandRepository", () => {
    let repository: MasterCarBrandRepository;

    beforeEach(() => {
        jest.clearAllMocks();
        repository = new MasterCarBrandRepository();
    });

    it("Create should save and return entity", async () => {
        const mockSave = jest.fn().mockResolvedValue({ id: "1", CarBrandName: "Toyota" });
        (MasterCarBrandEntity as any).mockImplementation(() => ({ save: mockSave }));
    ...
    it("FindAll should return all entities", async () => {
        ...
        (MasterCarBrandEntity as any).find = mockFind;
    ...
    it("FindById should return entity by id", async () => {
        ...
        (MasterCarBrandEntity as any).findById = mockFindById;
    ...
    it("Update should update and return the entity", async () => {
        ...
        (MasterCarBrandEntity as any).findByIdAndUpdate = mockFindByIdAndUpdate;
    ...
    it("DeleteOne should delete entity and return it", async () => {
        ...
        (MasterCarBrandEntity as any).findByIdAndDelete = mockFindByIdAndDelete;
