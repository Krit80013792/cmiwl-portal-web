...
import { UserGroupsEntity } from '@/src/domain/entities/UserGroupsEntity'
import { IUserGroup } from '@/src/domain/models/UserGroupModel'
import { IUserGroupRepository } from '@/src/application/interfaces/IUserGroupRepository'
