import { IMasterCarBrandRankingRepository } from '@/src/application/interfaces/IMasterCarBrandRankingRepository'
...
export class MasterCarBrandRankingRepository implements IMasterCarBrandRankingRepository {
  ...
  async update(
    psId: string,
    poMasterCarBrandRanking: Partial<IMasterCarBrandRanking>,
  ): Promise<IMasterCarBrandRanking | null> {
