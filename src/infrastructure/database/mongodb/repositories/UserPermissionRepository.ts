import { UserPermissionsEntity } from '../../../../domain/entities/UserPermissionsEntity';
import { IUserPermission } from '../../../../domain/models/UserPermissionModel';
import { IUserPermissionRepository } from '../../../../application/interfaces/IUserPermissionRepository';
