import { MasterCompulsoryRateEntity } from '../../../../domain/entities/MasterCompulsoryRateEntity';
import { IMasterCompulsoryRate } from '../../../../domain/models/MasterCompulsoryRateModel';
import { IMasterCompulsoryRateRepository } from '../../../../application/interfaces/IMasterCompulsoryRateRepository';
...
export class MasterCompulsoryRateRepository implements IMasterCompulsoryRateRepository {
    ...
    async update(psId: string, poMasterCompulsoryRate: Partial<IMasterCompulsoryRate>): Promise<IMasterCompulsoryRate | null> {
