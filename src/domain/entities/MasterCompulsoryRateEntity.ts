...
const MasterCompulsoryRateSchema: Schema = new Schema(
  {
    ...
    subCarType: { type: String, required: true },
...
export const MasterCompulsoryRateEntity =
  mongoose.models.MasterCompulsoryRate ||
  mongoose.model<IMasterCompulsoryRate>('MasterCompulsoryRate', MasterCompulsoryRateSchema)
