        ...
        return (
            <>
                {(clientPerms ?? []).includes('configs:read') && (
                    <Button icon="pi pi-search" rounded text label="View" severity="info" className="mr-2" onClick={() => onOpenModalView(rowData?.keyCode)} />
                )}
                {['configs:create', 'configs:update'].some(perm => (clientPerms ?? []).includes(perm)) && (
                    <Button icon="pi pi-pencil" rounded text label="Edit" severity="secondary" className="mr-2" onClick={() => onOpenModalConfigs(rowData?.keyCode)} />
                )}
    ...
    return (
        <div className="grid">
            <div className="col-12">
                <div className="card">
                    <Toast ref={toast} />
                    <h5><i className="pi pi-wrench" style={{ fontSize: '2rem' }}></i><strong> Channel Configs</strong></h5>
                </div>
                ...
                <Dialog visible={configsDialog} style={{ width: '550px' }} header="Channel configs" modal maximizable className="p-fluid" footer={configsDialogFooter} onHide={hideConfigsDialog}>
                    <div className="field">
                        <label htmlFor="primaryColor"><span style={{ color: "red" }}>*</span> Primary Color </label><br />
                        <ColorPicker format="hex" value={configValue?.primaryColor} onChange={(e) => onInputPrimaryColorChange(e?.value as string)} /><br />
                        <p><span>Code: {configValue?.primaryColor}</span></p>
                    </div>
                    <div className="field">
                        <label htmlFor="secondaryColor"><span style={{ color: "red" }}>*</span> Secondary Color </label><br />
                        <ColorPicker format="hex" value={configValue?.secondaryColor} onChange={(e) => onInputSecondaryColorChange(e?.value as string)} /><br />
                        <p><span>Code: {configValue?.secondaryColor}</span></p>
                    </div>
                    <div className="field">
                        <label htmlFor="oicCertTxt"><span style={{ color: "red" }}>*</span> Cert text </label>
                        <InputText
                            id="oicCertTxt"
                            name="oicCertTxt"
                    ...
                    <div className="field">
                        <label htmlFor="oicCertImg"><span style={{ color: "red" }}>*</span> Cert Img </label>
                        <FileUpload
                            ref={fileUploadRef}
                            id="oicCertImg"
                            accept=".jpg,.jpeg"
                    ...
                    <div className="field">
                        <label htmlFor="oicCertElectronicTxt"><span style={{ color: "red" }}>*</span> Cert Electronic text </label>
                        <InputText
                        ...
                        />
                        {submitted && !configValue?.oicCertElectronicTxt && <small className="p-invalid">Cert Electronic text is required.</small>}
                    </div>
                    <div className="field">
                        <label htmlFor="oicCertElectronicImg"><span style={{ color: "red" }}>*</span> Cert Electronic Img </label>
                        <FileUpload
                            ref={fileUploadRef}
                ...
                <Dialog visible={viewDialog} style={{ width: '550px' }} header="Channel configs detail" modal maximizable className="p-fluid" onHide={() => setViewDialog(false)}>
                    <div className="field">
                        <label htmlFor="primaryColor"><span style={{ color: "red" }}>*</span> Primary Color </label><br />
                        <ColorPicker format="hex" value={configValue?.primaryColor} /><br />
                        <p><span>Code: {configValue?.primaryColor}</span></p>
                    </div>
                    <div className="field">
                        <label htmlFor="secondaryColor"><span style={{ color: "red" }}>*</span> Secondary Color </label><br />
                        <ColorPicker format="hex" value={configValue?.secondaryColor} /><br />
                        <p><span>Code: {configValue?.secondaryColor}</span></p>
                    </div>
                    <div className="field">
                        <label htmlFor="vOicCertTxt"><span style={{ color: "red" }}>*</span> Cert text </label>
                        <InputText
                            id="vOicCertTxt"
                            name="vOicCertTxt"
                            value={configValue?.oicCertTxt}
                    ...
                    <div className="field">
                        <label htmlFor="vOicCertImg"><span style={{ color: "red" }}>*</span> Cert Img </label><br />
                        <Image src={configValue?.oicCertImg} alt={configValue?.oicCertTxt} width="80" height="60" preview />
                    </div>
                    <div className="field">
                        <label htmlFor="vOicCertElectronicTxt"><span style={{ color: "red" }}>*</span> Cert Electronic text </label>
                        <InputText
                    ...
                    <div className="field">
                        <label htmlFor="vOicCertElectronicImg"><span style={{ color: "red" }}>*</span> Cert Electronic Img </label><br />
                        <Image src={configValue?.oicCertElectronicImg} alt={configValue?.oicCertElectronicTxt} width="80" height="60" preview />
                    </div>
                </Dialog>
