...
const UsersPage = () => {
  ...
  const saveUser = async (e: React.FormEvent) => {
    ...
    if (oUser?.userId) {
      if (!oUser.userGroupId || !oUser.userRoleId) {
        setSubmitted(true)
        setUserDialog(true)
        setLoading(false)
        return
      ...
      if (!oUser.userName || !oUser.password || !oUser.userGroupId || !oUser.userRoleId || !allValidPw) {
        setSubmitted(true)
        setUserDialog(true)
        setLoading(false)
        return
    ...
    return (
      <div className="flex justify-content-between">
        ...
        <span className="p-input-icon-right">
          ...
          <InputText
            value={globalFilterUsersValue}
            onChange={onGlobalFilterUsersChange}
    ...
    return (
      <div className="flex justify-content-between">
        ...
        <span className="p-input-icon-right">
          <i className="pi pi-search" />
          <InputText
            value={globalFilterUserGroupsValue}
            onChange={onGlobalFilterUserGroupsChange}
    ...
    return (
      <div className="flex justify-content-between">
        ...
        <span className="p-input-icon-right">
          <i className="pi pi-search" />
          <InputText
            value={globalFilterUserRolesValue}
            onChange={onGlobalFilterUserRolesChange}
  ...
  const permissionCheckboxTemplate = (perm: keyof any['permissions']) => {
    const CheckboxTemplate = (rowData: any, { rowIndex }: { rowIndex: number }) => {
      return (
        <Checkbox
    ...
    CheckboxTemplate.displayName = `PermissionCheckboxTemplate_${String(perm)}`
      ...
      <div className="grid">
        <div className="col-12 md:col-6">
          <div className="card">
            ...
            <Dialog
              visible={userGroupDialog}
              style={{ width: '450px' }}
              header="Group"
              modal
              maximizable
              className="p-fluid"
              footer={userGroupDialogFooter}
              onHide={hideUserGroupDialog}
            >
              <div className="field">
            ...
            <Dialog
              visible={deleteUserGroupDialog}
              style={{ width: '450px' }}
              header="Confirm"
              modal
              footer={deleteUserGroupDialogFooter}
              onHide={hideDeleteUserGroupDialog}
            >
              <div className="flex align-items-center justify-content-center">
                <i className="pi pi-exclamation-triangle mr-3" style={{ fontSize: '2rem' }} />
                {userGroup && (
                  <span>
                    Are you sure you want to delete <b>{userGroup?.userGroupName}</b>?
                  </span>
                )}
              </div>
            </Dialog>
        ...
        <div className="col-12 md:col-6">
          <div className="card">
            ...
            >
              ...
              <Column
                header="Description"
                body={userRoleDescriptionBodyTemplate}
            ...
            <Dialog
              visible={deleteUserRoleDialog}
              style={{ width: '450px' }}
              header="Confirm"
              modal
              footer={deleteUserRoleDialogFooter}
              onHide={hideDeleteUserRoleDialog}
            >
              <div className="flex align-items-center justify-content-center">
                <i className="pi pi-exclamation-triangle mr-3" style={{ fontSize: '2rem' }} />
                {userRole && (
                  <span>
                    Are you sure you want to delete <b>{userRole?.userRoleName}</b>?
                  </span>
                )}
              </div>
            </Dialog>
