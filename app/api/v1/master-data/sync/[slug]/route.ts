...
export async function PATCH(poReq: NextRequest) {
    ...
    try {
        ...
        switch (sModuleEndpoint) {
            case 'car-brands':
                url = `https://cmiwl-dev.tidlortech.com/api/background-job/v1/car-brand`
                break;
            case 'car-brands-ranking':
                url = `https://cmiwl-dev.tidlortech.com/api/background-job/v1/car-brand-ranking`
                break;
            case 'car-colors':
                url = `https://cmiwl-dev.tidlortech.com/api/background-job/v1/car-color`
                break;
            case 'channels':
                url = `https://cmiwl-dev.tidlortech.com/api/background-job/v1/channel`
                break;
            case 'compulsory-groups':
                url = `https://cmiwl-dev.tidlortech.com/api/background-job/v1/compulsory-group`
                break;
            case 'compulsory-rates':
                url = `https://cmiwl-dev.tidlortech.com/api/background-job/v1/compulsory-rate`
                break;
            case 'compulsory-types':
                url = `https://cmiwl-dev.tidlortech.com/api/background-job/v1/compulsory-type`
                break;
            case 'insurers':
                url = `https://cmiwl-dev.tidlortech.com/api/background-job/v1/insurer`
                break;
            default:
                break;
        }
