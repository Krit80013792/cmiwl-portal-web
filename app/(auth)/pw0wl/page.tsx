                    ...
                    <div className="w-full surface-card py-8 px-5 sm:px-8" style={{ borderRadius: '53px' }}>
                        ...
                        <form onSubmit={onAuthentication}>
                            <div>
                                ...
                                <InputText id="email1" value={usr} onChange={(e) => setUsr(e.target.value)} required type="text" placeholder="Username" className="w-full md:w-30rem mb-5" style={{ padding: '1rem' }} />
