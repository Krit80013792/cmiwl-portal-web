        ...
        <div className="bg-building pt-4">
          <div className="container-md ">
            <div className="text-center pt-0 sign-red">
              <h1 className="mb-0 fs-24 text-black">
                <strong className="f-bd">“เตรียมเลขตัวถัง”</strong>
              </h1>
              <p className="f-r mb-2 fs-5">
                ให้พร้อมก่อน ซื้อ <strong className="f-bd">พ.ร.บ.</strong> ได้จาก
              </p>
              <img
                src="/cmisite/media/assets/check-list-frame.png"
              ...
              <img
                ...
                width="320"
                height="229"
                src="/cmisite/media/assets/intro-ctp-group-circle-1.png"
            ...
            <div className="container">
              <div className="into-content-wrapper position-relative">
                <div className="text-center text-intro-wrapper">
                  ...
                  <a
                    title="เงื่อนไขและรายละเอียดความคุ้มครอง"
                    className="fs-14 text-grey d-block"
                    href="/th/coverage-tc"
                    data-cf-modified-e9c163d6727633da1d0a186d-=""
                  >
                  ...
                  <div className="pb-4 pt-3">
                    ...
                    <a
                      className="btn btn-primary fs-6 d-flex justify-content-center align-items-center mx-auto continue-btn"
                      href="/th/VehicleCTP"
                      data-cf-modified-e9c163d6727633da1d0a186d-=""
                    >
                      <strong className="f-bd">ดำเนินการต่อ</strong>
                      <img
                        className="img-fluid ms-6"
                        alt="ดำเนินการต่อ"
                        src="/assets/icon/next-white.png"
                        width="20"
                        height="20"
                      />
                    </a>
              ...
              <div className="text-sm-center license-linkBoxWrapper d-flex justify-content-sm-center">
                <div className="license-linkBox pb-4">
                  ...
                  <a
                    title={configValue?.oicCertTxt}
                    className="fs-12 text-placeholder d-block text-decoration-none"
                    href="/th/oic-certificate"
                    data-cf-modified-e9c163d6727633da1d0a186d-=""
                  >
                  ...
                  <a
                    title={configValue?.oicCertElectronicTxt}
                    className="fs-12 text-placeholder d-block text-decoration-none"
                    href="/th/oic-certificate-electronic"
                    data-cf-modified-e9c163d6727633da1d0a186d-=""
                  >
