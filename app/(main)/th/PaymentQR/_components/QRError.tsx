      ...
      <div className="container d-flex flex-column align-items-center justify-content-center" style={{ maxWidth: '384px', minHeight: '100vh' }}>
        <div className="text-center">
          ...
          <p className="mb-1" style={{ fontSize: '18px', fontWeight: 700, color: '#1E1E1F', lineHeight: '26px' }}>
            ขออภัยไม่สามารถ
            <br />
            สร้าง QR Code ได้ในขณะนี้
          </p>
          <p className="mb-4" style={{ fontSize: '14px', color: '#6B6C6F' }}>
            ลองใหม่อีกครั้ง หรือเปลี่ยนช่องทางการชำระเงิน
          </p>
        </div>
        ...
        <div className="w-100 mt-2">
          ...
          >
            <span style={{ fontSize: '16px', fontWeight: 600 }}>ลองอีกครั้ง</span>
          </button>
          <button
            type="button"
