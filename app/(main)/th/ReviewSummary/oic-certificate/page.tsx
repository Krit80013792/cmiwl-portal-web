...
export async function generateMetadata(): Promise<Metadata> {
    return {
        title: 'เลขที่ใบอนุญาตประกันวินาศภัย | ติดล้อ',
        description: 'เลขที่ใบอนุญาตประกันวินาศภัย | ติดล้อ'
    };
};
        ...
        <main>
            <div className="head-bar">
                <div className="container d-flex align-items-center">
                    <a href="/th/ReviewSummary" className="back-btn"><img alt="กลับ" width="36" height="36" src="/assets/icon/back.png" /></a>
            ...
            <div className="container px-0">
                <div className="mt-12">
                    <img className="img-fluid certificate-img" alt="เลขที่ใบอนุญาตประกันวินาศภัย" src="/cmisite/media/assets/broker-license.jpg" />
                </div>
            </div>
